...
from clawdeck.agent import ClawdeckAgent, _get_client_choice, _validate_aws_credentials, _validate_openai_credentials
...
class TestOpenAIAgent:
    """Test ClawdeckAgent with OpenAI mode."""

    @patch('clawdeck.agent.OpenAIResponsesModel')
...
class TestBedrockAgent:
    ...
    def test_anthropic_mode_missing_api_key(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            with pytest.raises(ValueError, match="ANTHROPIC_API_KEY is required"):
                ClawdeckAgent(use_bedrock=False)
    ...
    def test_model_priority_order(self, mock_agent, mock_bedrock):
        ...
        mock_config = Mock(spec=ClawdeckConfig)
...
class TestBedrockEdgeCases:
    ...
    def test_explicit_use_bedrock_false(self, mock_agent):
        ...
        with patch.dict(os.environ, {
            ...
            agent = ClawdeckAgent(use_bedrock=False)
