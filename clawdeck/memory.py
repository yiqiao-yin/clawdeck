"""
Clawdeck Memory System - Persistent cross-session memory with relevance selection.

File-based memory stored in ~/.clawdeck/memory/ with MEMORY.md as index.
...
class MemoryManager:
    ...
    def __init__(self, memory_dir: Optional[Path] = None):
        self.memory_dir = memory_dir or (Path.home() / ".clawdeck" / MEMORY_DIR_NAME)
