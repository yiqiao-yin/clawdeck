"""
Vision Fallback Integration for Clawdeck CLI
...
class VisionFallbackIntegration:
    ...
    def __init__(self, agent=None):
        ...
        Args:
            agent: ClawdeckAgent instance (optional, will be injected during execution)
        """
        self.agent = agent
    ...
    def is_available(self, agent=None) -> bool:
        ...
        Args:
            agent: ClawdeckAgent instance to check
    ...
    async def execute_vision_fallback(
        ...
        Args:
            ...
            agent: ClawdeckAgent instance (optional override)
