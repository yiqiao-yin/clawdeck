"""
Session Manager for Clawdeck-CLI (Phase 4.2.1)
...
~/.clawdeck/
  └── sessions/
      ├── clawdecksearch_com.session.json
...
class SessionManager:
    ...
    def __init__(self, sessions_dir: Optional[Path] = None):
        ...
        Args:
            sessions_dir: Directory for storing sessions (default: ~/.clawdeck/sessions/)
        """
        if sessions_dir is None:
            self.sessions_dir = Path.home() / ".clawdeck" / "sessions"
        else:
