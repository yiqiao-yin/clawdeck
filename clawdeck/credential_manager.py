"""
Credential Manager for Clawdeck-CLI (Phase 4.1)
...
class CredentialManager:
    ...
    def __init__(self, credentials_dir: Optional[Path] = None):
        ...
        Args:
            credentials_dir: Directory for storing credentials (default: ~/.clawdeck/credentials/)
        """
        if credentials_dir is None:
            self.credentials_dir = Path.home() / ".clawdeck" / "credentials"
        else:
        ...
        self.audit_log = Path.home() / ".clawdeck" / "logs" / "auth_audit.log"
    ...
    def save_credential(self, domain: str, username: str, password: str) -> bool:
        ...
        Args:
            domain: Website domain (e.g., "clawdecksearch.com")
